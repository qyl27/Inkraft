...
public class StoryFunctions {
    public static final ResourceLocation REGISTRY_NAME = new ResourceLocation(InkraftMod.ID, "story_functions");
    public static final ResourceKey<Registry<StoryFunction>> REGISTRY_KEY = ResourceKey.createRegistryKey(REGISTRY_NAME);
    public static final Registrar<StoryFunction> REGISTRAR = RegistrarManager.get(InkraftMod.ID).<StoryFunction>builder(REGISTRY_NAME).build();

    public static final DeferredRegister<StoryFunction> FUNCTIONS = DeferredRegister.create(InkraftMod.ID, REGISTRY_KEY);
